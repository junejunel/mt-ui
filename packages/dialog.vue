...
.mt-dialog__wrapper{
  ...
  .mt-dialog{
    ...
    &__footer{
      ...
      text-align: right;
      box-sizing: border-box;
      ::v-deep .mt-button:first-child{
        margin-right: 20px;
      }
    }
  }
}
.diolog-fade-enter-active {
  animation: fade .3s;
}

.diolog-fade-leave-active { // 离开时动画效果反转
